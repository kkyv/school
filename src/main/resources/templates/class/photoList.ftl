...
<div class="dbody">
    <div class="dsize">
        <div class="head">
            <div class="headimg">
                <img src="/school/img/c_20.jpg"/>
            </div>
        </div>
        <nav id="nav">
            <ul >
                <li><a href="http://www.divcss5.com/">班级首页</a></li>
                <li><a href="http://www.divcss5.com/rumen/">班级相册</a></li>
                <li><a href="http://www.divcss5.com/css-tool/">班级成员</a></li>
                <li><a href="http://www.divcss5.com/css-texiao/">留言板</a></li>
        ...
        <div class="center">
            <div class="left">
                ...
                <div class="birthday gree_box">
					...
					<div class="c_img_box">
						<img src="/school/img/nophoto.jpg"/>
						<span>生日</span>
						<span>名字</span>
					</div>
					<div class="c_img_box">
